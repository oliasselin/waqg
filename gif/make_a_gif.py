...
def make_a_gif(run,sli,field,fixed_cbrange='',cbmin=-0.005,cbmax=0.0005,nmax=1000,hres=128,vres=128,U_scale=0.1/(2*np.pi),L_scale=1600000/(2*np.pi),timestep=0.01,time_unit='days'):
