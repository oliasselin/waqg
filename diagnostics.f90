...
!************************************************************************!
 ...
 END SUBROUTINE plot_ensz
  ...
  subroutine slices(uk,vk,wk,bk,wak,u_rot,ur,vr,wr,br,war,u_rotr,psir,psi_solr,id_field)
    ...
    double precision,    dimension(n1d,n2d,n3h1) :: psir,psi_solr
    ...
    elseif(id_field==6) then   !Fr^2/Ro * b_z/r_2 << 1 ? (Limiting QG assumption)                                                                                                                                                           
       ...
       field = Ro*zzr
    else if(id_field==8) then
       field = psir
    else if(id_field==9) then 
       field = psi_solr
    end if
