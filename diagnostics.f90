...
337                format(1x,I5,1x,I5,1x)                  
             ...
             if(check_error==1) then
                ...
                do iz=1,n3
                   ...
                   DRkt(ikx,iz,ikyp)= ReU(iz) + i*ImU(iz)
                   DIkt(ikx,iz,ikyp)= ReV(iz) + i*ImV(iz)
    ...
    if(check_error==1) then 
       ...
       !Transpose D to the regular z-parallelized world                                                                                                                                
  ...
  subroutine spec_A2(ARkt,AIkt,DRk,DIk)
