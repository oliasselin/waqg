...
set output '../figures/qg_test_cpu_npe2.eps'
...
set ylabel '{CPU time per time step (seconds)}'
...
plot  "/home1/05518/oasselin/waqg/data/cputime_qg_npe.dat"  u 2:3 w lp ls 24 title 'n_x = 8, n_y = 128, n_z = 4096', \
      "/home1/05518/oasselin/waqg/data/cputime_qg_npe2.dat" u 2:3 w lp ls 15 title 'n_x = 8, n_y = 512, n_z = 2048', \
      0.7*x**(-1.)  w l ls 16 title 'O(1/number of tasks)'
