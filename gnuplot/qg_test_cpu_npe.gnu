...
set output '../figures/qg_test_cpu_npe.eps'
...
set xlabel '{Number of tasks (fixed n_x = 8, n_y = 128, n_z = 2048)}'
#set xtics 1
#set ytics 0.2
set format y "10^{%T}"
...
plot  "/home1/05518/oasselin/waqg/data/cputime_qg_npe.dat" u 2:3 w lp ls 24 title 'CPU time (QG part only)', \
      0.7*x**(-1.)  w l ls 16 title 'O(1/#tasks)'
