...
#set output '../figures/qg_test_cpu.eps'
...
plot  "/home1/05518/oasselin/waqg/python/cputime_qg.dat" u (twopi/$1):2 w lp ls 24 title 'CPU time (QG part only)', \
      0.0001*x**(1.)  w l ls 16 title 'O(n_z)'
