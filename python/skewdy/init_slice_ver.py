...
path_u  = scratch_location+folder+run+'/output/slicev1'+spaces_ts+str(ts)+'.dat'
path_v  = scratch_location+folder+run+'/output/slicev2'+spaces_ts+str(ts)+'.dat'
...
#            ax.set_title(r'$\zeta/f$',fontsize=16)
            ...
            ax.text(-30, 512/2,r'$\leftarrow$ 3 km $\rightarrow$',rotation='vertical',horizontalalignment='center',verticalalignment='center', fontsize=12)
            ...
            ax.text(-512/4, 512/2,r'Vertical profile ($y=111$ km)',rotation='vertical',horizontalalignment='center',verticalalignment='center', fontsize=16)
        else:
...
plt.savefig('plots/'+run+'init_slice_ver.eps')
#plt.show()
