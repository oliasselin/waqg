...
plot "data/dkdt.dat" u 1:2     w l ls 1 title 'd/dt WKE', \
     "data/dkdt.dat" u 1:($3)  w l ls 2  title 'Forcing', \
     "data/dkdt.dat" u 1:($4)  w l ls 4 title 'Dissipation', \
     0 w l ls 9 notitle
