...
set ylabel '{/Helvetica-Oblique Energy density (m^2 s^{-2})}'
set xlabel '{/Helvetica-Oblique Eddy turnover times}'

twopi=6.28318530718

set title "Time-integrated contributions to wave kinetic energy"
plot "data/k.dat" u 1:2     w l ls 1 title 'WKE', \
     "data/k.dat" u 1:3 w l ls 2  title 'Forcing', \
     "data/k.dat" u 1:4 w l ls 4 title 'Dissipation', \
     0 w l ls 9 notitle
