...
#ax1.set_ylim(0, 2)                                                                                                                                                                      
    ...
    ax1.plot(time,dpdt,label=r'$\frac{d}{dt}$ WPE',color='k',linewidth=1.2)
    ax1.plot(time,refr,label=r'$\Gamma_r$ (refraction)',color='g',linewidth=1.2)
#    ax1.plot(time,advp,label=r'Advection (perturbation)',color='b')
    ax1.plot(time,advp,label=r'$\Gamma_a$ (advection)',color='b',linewidth=1.2)
#    ax1.plot(time,advm,label=r'Advection (mean-flow)',color='r')
    ax1.plot(time,diss,label=r'$\Gamma_d$ (dissipation)',color='r',linewidth=1.2)
