MODULE mpi
  ...
  integer :: tag_slice_xz(nfields) = [141,142,143,144,145,146,147]  !Up to 14X where X is the number of fields to slice
  integer :: tag_slice_xzw(nfieldsw) = [1141,1142,1143,1144,1145,1146]  !Up to 114X where X is the number of fields to slice
